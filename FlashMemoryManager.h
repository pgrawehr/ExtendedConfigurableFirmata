...
public:
	...
	void Init(void*& classes, void*& methods, void*& constants, void*& stringHeap, int& startupToken, int& startupFlags);
	/// <summary>
	...
	void WriteHeader(int dataVersion, int hashCode, void* classesPtr, void* methodsPtr, void* constantsPtr, void* stringHeapPtr, int startupToken, int startupFlags);
